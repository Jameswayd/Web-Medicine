function buzhidao() {
    ...
    xhr.open("GET", "http://localhost/Web-Medicine/suibiancheshi/get_yaoping.php", true);
    xhr.send();
...
function sendDataToPhp() {
    $.ajax({
        url: "http://localhost/suibiancheshi/get_yaoping.php",
        method: "POST",
        data: { value: valueToSend },
        success: function (response) {
            console.log("PHP 傳回的回應: " + response);
        },
